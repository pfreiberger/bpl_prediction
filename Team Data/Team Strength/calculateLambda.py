...
class Lambda(object):
	...
	"""
	def __init__(self, season,database,xmin,xmax,RANGE):
	...
	def calculateLambda(self):
		...
		#self.printResult()
		return(round((self.successScore*100.0)/(10*1.0)),round((self.successOutCome*100.0)/(10*1.0)))
		print("Real Draw Number = "+str(realDraw))
		print("Predicted Draw = "+str(predictedDraw))

	def printResult(self):
		print("Score Success : "+str(round((self.successScore*100.0)/(10*1.0)))+"%")
		print("Prediction Result : "+str(round((self.successOutCome*100.0)/(10*1.0)))+"%")
